...
(function($PS) {
  ...
  var escapeRegex = function (str) {
      ...
      var $16 = Data_String_Regex.test(hasReg)(str);
      if ($16) {
      ...
      var handleFile = function (dir) {
          return function (file) {
              ...
              return Control_Bind.bind(Effect_Aff.bindAff)(Node_FS_Aff.stat(file$prime))(function (v) {
                  var $22 = Node_FS_Stats.isFile(v);
                  if ($22) {
                      return fileManifest(opts)(file$prime);
                  };
                  var $23 = Node_FS_Stats.isDirectory(v);
                  if ($23) {
      ...
      return function (manifest) {
          return function (v) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(mkdirp(Node_Path.dirname(to$prime)))(function () {
                  var $37 = Data_Foldable.notElem(Data_Foldable.foldableArray)(Data_Eq.eqString)(Node_Path.extname(to$prime))(replaceURLTargets);
                  if ($37) {
  ...
  var rev = function (opts) {
      return Control_Bind.bind(Effect_Aff.bindAff)(createManifest(opts))(function (v) {
          return Control_Parallel.parSequence_(Effect_Aff.parallelAff)(Data_Foldable.foldableArray)([ outputManifest(opts)(v), build(opts)(v) ]);
      });
  };
  var main = (function () {
      var cb = function (v) {
      ...
      return function __do() {
          ...
          if (v.length === 4) {
              return Effect_Aff.runAff_(cb)(Control_Bind.bind(Effect_Aff.bindAff)(createOpts(v[2])(v[3]))(rev))();
          };
