...
(function($PS) {
  ...
  var escapeRegex = function (str) {
      ...
      var $14 = Data_String_Regex.test(hasReg)(str);
      if ($14) {
      ...
      var handleFile = function (dir) {
          return function (file) {
              ...
              return Control_Bind.bind(Effect_Aff.bindAff)(Node_FS_Aff.stat(file$prime))(function (v) {
                  var $20 = Node_FS_Stats.isFile(v);
                  if ($20) {
                      return fileManifest(opts)(file$prime);
                  };
                  var $21 = Node_FS_Stats.isDirectory(v);
                  if ($21) {
      ...
      return function (manifest) {
          return function (v) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(mkdirp(Node_Path.dirname(to$prime)))(function () {
                  var $35 = Data_Foldable.notElem(Data_Foldable.foldableArray)(Data_Eq.eqString)(Node_Path.extname(to$prime))(replaceURLTargets);
                  if ($35) {
  ...
  var main = (function () {
      ...
      return function __do() {
          ...
          if (v.length === 4) {
              return Effect_Aff.runAff_(cb)(rev({
                  inputDir: v[2],
                  outputDir: v[3]
              }))();
          };
