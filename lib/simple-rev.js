...
(function($PS) {
  ...
  var escapeRegExp = function (str) {
      ...
      var $11 = Data_String_Regex.test(reg)(str);
      if ($11) {
  ...
  var createManifest = function (opts) {
      var walk = function (dir) {
          return function (file) {
              ...
              return Control_Bind.bind(Effect_Aff.bindAff)(Node_FS_Aff.stat(file$prime))(function (v) {
                  var $16 = Node_FS_Stats.isFile(v);
                  if ($16) {
                      return hashedFilePath(file$prime);
                  };
                  var $17 = Node_FS_Stats.isDirectory(v);
                  if ($17) {
      ...
      var compareDepth = function (v) {
          return function (v1) {
              return Data_Ord.compare(Data_Ord.ordInt)(Data_Array.length(Data_String_Common.split("/")(v.value0)))(Data_Array.length(Data_String_Common.split("/")(v1.value0)));
          };
      };
      ...
      return function (manifest) {
          return function (v) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(mkdirp(Node_Path.dirname(to$prime)))(function () {
                  var $30 = Data_Foldable.notElem(Data_Foldable.foldableArray)(Data_Eq.eqString)(Node_Path.extname(to$prime))(replaceURLTargets);
                  if ($30) {
