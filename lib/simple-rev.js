...
(function($PS) {
  ...
  var outputManifest = function (opts) {
      return function (manifest) {
          var path = Node_Path.concat([ opts.outputDir, "manifest.json" ]);
          var json = Simple_JSON.writeJSON(Simple_JSON.writeForeignObject(Simple_JSON.writeForeignString))(Foreign_Object.fromFoldable(Data_Foldable.foldableArray)(manifest));
          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(mkdirp(opts.outputDir))(function () {
              return Node_FS_Aff.writeTextFile(Node_Encoding.UTF8.value)(path)(json);
          });
      };
  };
  ...
  var escapeRegex = function (str) {
      ...
      var hasReg = Data_String_Regex_Unsafe.unsafeRegex(Data_String_Regex.source(reg))(Data_String_Regex_Flags.noFlags);
      var $9 = Data_String_Regex.test(hasReg)(str);
      if ($9) {
  ...
  var createOpts = function (input) {
      return function (output) {
          return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Control_Apply.apply(Effect.applyEffect)(Data_Functor.map(Effect.functorEffect)(function (v) {
              return function (v1) {
                  return {
                      inputDir: v,
                      outputDir: v1
          ...
          })(Node_Path.resolve([  ])(input)))(Node_Path.resolve([  ])(output)));
      };
  };
  var contentHash = function (file) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Node_FS_Aff.readFile(file))(function (buf) {
          return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Node_Crypto_Hash.createHash(Node_Crypto_Hash.MD5.value))(Data_Function.flip(Node_Crypto_Hash.update)(buf)))(Node_Crypto_Hash.digest))(Node_Buffer_Class.toString(Node_Buffer.mutableBufferEffect)(Node_Encoding.Hex.value)));
      });
  };
  var fileManifest = function (opts) {
      return function (file) {
          ...
          if (v === "") {
              return Control_Bind.bind(Effect_Aff.bindAff)(contentHash(file))(function (hash) {
                  return Control_Applicative.pure(Effect_Aff.applicativeAff)([ Data_Tuple.Tuple.create(file$prime)(file$prime + ("-" + hash)) ]);
              });
          };
          return Control_Bind.bind(Effect_Aff.bindAff)(contentHash(file))(function (hash) {
              var reg = Data_String_Regex_Unsafe.unsafeRegex(escapeRegex(v) + "$")(Data_String_Regex_Flags.noFlags);
              return Control_Applicative.pure(Effect_Aff.applicativeAff)([ Data_Tuple.Tuple.create(file$prime)(Data_String_Regex.replace(reg)("-" + (hash + v))(file$prime)) ]);
          });
      };
  };
  var createManifest = function (opts) {
      ...
      var handleFile = function (dir) {
          return function (file) {
              ...
              return Control_Bind.bind(Effect_Aff.bindAff)(Node_FS_Aff.stat(file$prime))(function (stats) {
                  var $11 = Node_FS_Stats.isFile(stats);
                  if ($11) {
                      return fileManifest(opts)(file$prime);
                  };
                  var $12 = Node_FS_Stats.isDirectory(stats);
                  if ($12) {
      ...
      return function (manifest) {
          return function (v) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(mkdirp(Node_Path.dirname(to$prime)))(function () {
                  var $26 = Data_Foldable.notElem(Data_Foldable.foldableArray)(Data_Eq.eqString)(Node_Path.extname(to$prime))(replaceURLTargets);
                  if ($26) {
                      return Control_Bind.bind(Effect_Aff.bindAff)(Node_FS_Aff.readFile(from$prime))(Node_FS_Aff.writeFile(to$prime));
                  };
                  return Control_Bind.bind(Effect_Aff.bindAff)(Node_FS_Aff.readTextFile(Node_Encoding.UTF8.value)(from$prime))(function (txt) {
                      return Node_FS_Aff.writeTextFile(Node_Encoding.UTF8.value)(to$prime)(Data_Foldable.foldr(Data_Foldable.foldableArray)(replaceURL)(txt)(manifest));
                  });
              });
          };
      };
  ...
  var rev = function (opts) {
      return Control_Bind.bind(Effect_Aff.bindAff)(createManifest(opts))(function (manifest) {
          return Control_Parallel.parSequence_(Effect_Aff.parallelAff)(Data_Foldable.foldableArray)([ outputManifest(opts)(manifest), build(opts)(manifest) ]);
      });
  };
  var main = (function () {
      var cb = function (v) {
      ...
      return function __do() {
          ...
          if (xs.length === 4) {
              return Effect_Aff.runAff_(cb)(Control_Bind.bind(Effect_Aff.bindAff)(createOpts(xs[2])(xs[3]))(rev))();
          };
