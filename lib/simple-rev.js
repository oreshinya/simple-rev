...
(function($PS) {
  ...
  var escapeRegExp = function (str) {
      ...
      var $12 = Data_String_Regex.test(reg)(str);
      if ($12) {
  ...
  var hashedFilePath = function (file) {
      return Control_Bind.bind(Effect_Aff.bindAff)(contentHash(file))(function (v) {
          var file$prime = Data_String_Common.joinWith("/")(Data_Array.drop(1)(Data_String_Common.split("/")(file)));
          var v1 = Node_Path.extname(file$prime);
          if (v1 === "") {
              return Control_Applicative.pure(Effect_Aff.applicativeAff)([ Data_Tuple.Tuple.create(file$prime)(file$prime + ("-" + v)) ]);
          };
          if (v1 === ".html") {
              return Control_Applicative.pure(Effect_Aff.applicativeAff)([ new Data_Tuple.Tuple(file$prime, file$prime) ]);
          };
          var reg = Data_String_Regex_Unsafe.unsafeRegex(escapeRegExp(v1) + "$")(Data_String_Regex_Flags.noFlags);
          return Control_Applicative.pure(Effect_Aff.applicativeAff)([ Data_Tuple.Tuple.create(file$prime)(Data_String_Regex.replace(reg)("-" + (v + v1))(file$prime)) ]);
      });
  };
  var createManifest = function (opts) {
      var walk = function (dir) {
          return function (file) {
              ...
              return Control_Bind.bind(Effect_Aff.bindAff)(Node_FS_Aff.stat(file$prime))(function (v) {
                  var $17 = Node_FS_Stats.isFile(v);
                  if ($17) {
                      return hashedFilePath(file$prime);
                  };
                  var $18 = Node_FS_Stats.isDirectory(v);
                  if ($18) {
                      return handleDir(file$prime);
                  };
      ...
      var handleDir = function (dir) {
          return Data_Functor.mapFlipped(Effect_Aff.functorAff)(Control_Bind.bind(Effect_Aff.bindAff)(Node_FS_Aff.readdir(dir))(Control_Parallel.parTraverse(Effect_Aff.parallelAff)(Data_Traversable.traversableArray)(walk(dir))))(Data_Array.concat);
      };
      var compareDepth = function (v) {
          return function (v1) {
              var v2 = Data_Ord.compare(Data_Ord.ordInt)(Data_Array.length(Data_String_Common.split("/")(v.value0)))(Data_Array.length(Data_String_Common.split("/")(v1.value0)));
              if (v2 instanceof Data_Ordering.EQ) {
                  return Data_Ord.compare(Data_Ord.ordInt)(Data_String_CodePoints.length(v.value0))(Data_String_CodePoints.length(v1.value0));
              };
              return v2;
          };
      };
      return Data_Functor.mapFlipped(Effect_Aff.functorAff)(handleDir(opts.inputDir))(Data_Array.sortBy(compareDepth));
  };
      ...
      return function (manifest) {
          return function (v) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(mkdirp(Node_Path.dirname(to$prime)))(function () {
                  var $32 = Data_Foldable.notElem(Data_Foldable.foldableArray)(Data_Eq.eqString)(Node_Path.extname(to$prime))(replaceURLTargets);
                  if ($32) {
  ...
  var rev = (function () {
      var cb = function (v) {
          if (v instanceof Data_Either.Left) {
              return Effect_Console.log(Effect_Exception.message(v.value0));
          };
